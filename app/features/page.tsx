...
function useThreeScene(id: string) {
  ...
  useEffect(() => {
    ...
    if (id === "quantum") {
      ...
      nodePositions.forEach(([x1, y1, z1], i) =>
        nodePositions.forEach(([x2, y2, z2], j) => {
          if (j <= i) return;
      ...
      for (let i = 0; i < pts; i++) {
        ...
        const y = (i / pts) * 4 - 2;
        strand1.push(
          new THREE.Vector3(Math.cos(t) * 0.6, y, Math.sin(t) * 0.6),
        );
        strand2.push(
          new THREE.Vector3(
    ...
    const animate = () => {
      ...
      if (id === "robotics") {
        group.children.forEach((c, i) => {
          if (c instanceof THREE.Mesh)
            c.rotation.z = Math.sin(frame * 0.02 + i * 0.5) * 0.3;
        });
      }
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      scene.children.forEach((c, i) => {
        if (c instanceof THREE.Mesh && i > 1 && i < 5) {
          c.rotation.z += 0.001 + i * 0.0003;
        }
      });
      ...
      <div className="relative" style={{ zIndex: 10 }}>
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 70% 70% at 50% 50%, transparent 30%, rgba(0,0,0,0.8) 100%)",
              zIndex: 1,
            }}
          />
            ...
            >
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                <button
                  ...
                  className="px-10 py-3.5 bg-white text-black text-[10px] font-bold uppercase tracking-[0.2em] rounded-full transition-all duration-300 hover:scale-105 hover:bg-gray-100"
                >
                  Tour Facilities →
                </button>
                <button
        ...
        >
          ...
          >
            {stats.map((s, i) => (
              <motion.div
                ...
                whileHover={
                  { y: -6, borderColor: "rgba(255,255,255,0.22)" } as any
                }
              >
                <div
          ...
          >
            ...
            <h2
              className="font-black tracking-tighter mb-10"
              style={{
                fontSize: "clamp(32px,5vw,64px)",
                letterSpacing: "-0.03em",
                color: "rgba(255,255,255,0.12)",
            ...
            <p
              ...
              style={{ color: "rgba(255,255,255,0.35)" }}
            >
              Every student has 24/7 unrestricted access from the moment they
              enroll. No waiting lists. No gatekeeping.
            </p>
            <div className="flex gap-4 justify-center flex-wrap">
